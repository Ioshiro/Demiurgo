...
ISLRMDoubleTileFurniture = ISBuildingObject:derive("ISLRMDoubleTileFurniture");

--************************************************************************--
--** ISLRMDoubleTileFurniture:new
--**
--************************************************************************--
function ISLRMDoubleTileFurniture:create(x, y, z, north, sprite)
...
function ISLRMDoubleTileFurniture:walkTo(x, y, z)
...
function ISLRMDoubleTileFurniture:setInfo(square, north, sprite)
	-- add furniture to our ground
	local thumpable = IsoObject.new(getCell(), square, sprite, north, self);
...
function ISLRMDoubleTileFurniture:removeFromGround(square)
...
function ISLRMDoubleTileFurniture:new(name, sprite1, sprite2, northSprite1, northSprite2)
	local o = {};
	setmetatable(o, self);
	self.__index = self;
	o:init();
...
function ISLRMDoubleTileFurniture:getHealth()
	return 200 + buildUtil.getWoodHealth(self);
end

function ISLRMDoubleTileFurniture:render(x, y, z, square)
...
function ISLRMDoubleTileFurniture:isValid(square)
...
function ISLRMDoubleTileFurniture:getSquare2Pos(square, north)
	local x = square:getX()
	local y = square:getY()
	local z = square:getZ()
	if north then
...
function ISLRMDoubleTileFurniture:getSquare2(square, north)
